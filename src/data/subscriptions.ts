...
export const toolPlans: ToolPlan[] = [
  // ChatGPT Plans
  {
    ...
    durations: [
      { months: 1, price: 15 },
      { months: 3, price: 40, discount: 11 },
      { months: 6, price: 75, discount: 17 },
    ],
  ...
  },
  {
    ...
    durations: [
      { months: 1, price: 29 },
      { months: 3, price: 80, discount: 8 },
      { months: 6, price: 150, discount: 14 },
    ],
    deliveryMethod: "account_provided",
  ...
  },
  {
    ...
    durations: [
      { months: 1, price: 24 },
      { months: 3, price: 65, discount: 10 },
      { months: 6, price: 120, discount: 17 },
    ],
    deliveryMethod: "account_provided",
  ...
  },
  {
    ...
    durations: [
      { months: 1, price: 32 },
      { months: 3, price: 88, discount: 8 },
      { months: 6, price: 165, discount: 14 },
    ],
    deliveryMethod: "account_provided",
