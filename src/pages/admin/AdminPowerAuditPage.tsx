    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 p-6 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Power Audit</h1>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-4xl font-bold text-primary">{Number(metrics?.decision_authority_spread ?? 0).toFixed(2)}</p>
