...
fetch('https://api.rcollab.com/v1/tools', {
  method: 'GET',
  headers: headers
})
...
const response = await fetch('https://api.rcollab.com/v1/tools', {
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
  }
});
...
const response = await fetch('https://api.rcollab.com/v1/subscriptions', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
    'Content-Type': 'application/json'
        ...
        <div className="container px-4">
          ...
          >
            ...
            <p className="mt-4 text-sm sm:text-lg text-muted-foreground max-w-2xl mx-auto">
              Integrate RCollab services into your applications with our RESTful API.
            </p>
          </motion.div>
