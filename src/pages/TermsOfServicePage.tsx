        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <p>
                RCollab is an outcome-based professional platform for researchers, students, and institutions. 
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              <h4>Eligibility</h4>
              <ul>
                <li>You must be at least 18 years old to use RCollab</li>
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <p>RCollab is built on trust and accountability. You agree to:</p>
              <ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <ul>
                ...
                <li>You grant RCollab a license to display and process your content</li>
                <li>Project deliverables are governed by individual project agreements</li>
              </ul>

              <h4>Platform Content</h4>
              <ul>
                <li>RCollab owns all platform designs, features, and systems</li>
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <h4>Enforcement</h4>
              <p>RCollab may suspend or terminate accounts for:</p>
              <ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert max-w-none">
              <ul>
                <li>RCollab is provided "as is" without warranties</li>
