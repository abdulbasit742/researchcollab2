...
import { SupervisorReviewQueuePanel } from "@/components/projects/SupervisorReviewQueuePanel";
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          >
            ...
            <div className="rounded-lg border bg-muted/40 p-4 text-sm text-muted-foreground">
              This overview is the workspace home. Next features will connect this to real project records, health scoring, AI tools, research gap finding, literature review drafting, abstract generation, methodology assistance, viva prep, project risk AI, prompt library, saved AI outputs, AI safety feedback, and report builders.
            </div>
          </WorkspacePanel>
        </TabsContent>
