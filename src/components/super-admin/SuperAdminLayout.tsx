...
import {
  ...
  Stethoscope, Flame, Search, Gauge, Bell, Siren, BookOpen,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Incidents", href: "/super-admin/incidents", icon: Siren },
  { label: "Runbooks", href: "/super-admin/runbooks", icon: BookOpen },
];
