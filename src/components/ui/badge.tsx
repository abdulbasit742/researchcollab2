  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        premium: "border-transparent gradient-primary text-primary-foreground shimmer",
        glow: "border-transparent bg-primary text-primary-foreground shadow-glow animate-glow-pulse",
        new: "border-transparent bg-accent text-accent-foreground animate-bounce-subtle",
      },
    },
    defaultVariants: {
      variant: "default",
