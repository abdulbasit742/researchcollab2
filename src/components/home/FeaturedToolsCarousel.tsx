...
const tools = [
  {
    icon: FileText,
    name: "RCollab Docs",
    tagline: "Academic writing with built-in citations",
  ...
  },
  {
    icon: Presentation,
    name: "RCollab Slides",
    tagline: "Conference-ready presentations",
  ...
  },
  {
    icon: Search,
    name: "Smart Matching",
    tagline: "Find the perfect collaborator",
  ...
  },
  {
    ...
    tagline: "Track your research impact",
  ...
  },
  {
    icon: BookOpen,
    name: "Grant Finder",
    tagline: "Discover funding opportunities",
  ...
  },
  {
    icon: PenTool,
    name: "Deal Rooms",
    tagline: "Structured collaboration spaces",
          ...
          {tools.map((tool, index) => (
            ...
            >
              <Link to={tool.href} className="block h-full">
                <Card className="h-full group hover:shadow-lg transition-all duration-300 hover:border-primary/30 border-border/50">
                  <CardContent className="p-5 flex flex-col gap-3">
                    <div className="flex items-start justify-between">
                      <div
                        className={`flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br ${tool.gradient}`}
                      >
