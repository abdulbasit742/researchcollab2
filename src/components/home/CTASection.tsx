...
import { ArrowRight, Shield, Banknote, CheckCircle2, Sparkles } from "lucide-react";

const proofPoints = [
  { icon: Shield, text: "Escrow-protected payments" },
  { icon: CheckCircle2, text: "Milestone-based execution" },
  { icon: Banknote, text: "Sponsor ROI tracked" },
];
        ...
        >
          ...
          <div className="relative p-10 md:p-20 lg:p-28 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base md:text-lg text-white/40 leading-relaxed">
              Students create projects. Sponsors fund them. Milestones execute. Trust compounds.
              Every completed FYP is a hiring signal.
            </p>
            ...
            <p className="mt-8 text-xs text-white/25">
              No credit card required · Escrow protection from day one
            </p>
          </div>
        </motion.div>
      </div>
